...
public class Buscar extends javax.swing.JFrame {
   ...
   StringBuilder chatactual;  
    ...
    public Buscar() {
        ...
        // Esta función es el constructor de la clase Buscar e inicializa la interfaz gráfica de la ventana del chatbot.
        //initComponents(): Llama a este método para configurar todos los componentes de la interfaz gráfica.
        //modeloHistorial: Inicializa un DefaultListModel para manejar el historial de chats.
        //chats: Crea un arreglo bidimensional para almacenar los chats.
        //chatcount: Lleva el conteo del número de chats guardados.
        //chatactual: Usa un StringBuilder para construir el texto de cada conversación de chat actual.
    ...
    private void btnenviarMouseClicked(java.awt.event.MouseEvent evt) {                                       
        ...
        try {
           ...
           txtpregunta.setText("");
        // Esta función se ejecuta cuando el usuario hace clic en el botón "Enviar". Envía la pregunta al chatbot y maneja la respuesta.
        // Validación de entrada: Verifica si el campo de texto de la pregunta está vacío. Si es así, limpia el área de chat y termina la ejecución.
        // Conexión HTTP: Envía una solicitud POST con el modelo y la pregunta al servidor del chatbot, que devuelve una respuesta JSON.
        // Manejo de Respuesta: Dependiendo del código de respuesta HTTP, toma la respuesta del bot y la muestra en el área de texto txtchat.
        // Actualización del chatactual: Almacena el intercambio de mensajes de la conversación actual en chatactual.

    }                                      

    private void lsthistorialMouseClicked(java.awt.event.MouseEvent evt) {                                          
       ...
       // Esta función maneja la carga de un chat guardado del historial cuando el usuario hace clic en un elemento de la lista.
       // indice: Obtiene el índice del chat seleccionado en el historial.
       // Carga de chat: Si el índice es válido, carga el chat correspondiente en txtchat para que el usuario lo pueda ver.
        
    }                                         

    private void btnnuevochatMouseClicked(java.awt.event.MouseEvent evt) {                                          
     ...
     chatactual.setLength(0);
        ...
        // Esta función guarda la conversación actual en el historial y limpia los campos de chat para iniciar una nueva conversación.
        // Guardado de chat: Si hay una conversación en chatactual y no se ha alcanzado el límite de chats, la agrega al arreglo chats y al modeloHistorial.
        // Reset de chat: Limpia el campo de texto txtchat y txtpregunta y reinicia chatactual para comenzar un nuevo chat.
    }                                         
